...
import { APIPromise } from 'yolken-test-3-11-2/core/api-promise';

import util from 'node:util';
import YolkenTest3_11_2 from 'yolken-test-3-11-2';
import { APIUserAbortError } from 'yolken-test-3-11-2';
...
describe('instantiate client', () => {
  ...
  describe('defaultHeaders', () => {
    const client = new YolkenTest3_11_2({
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['YOLKEN_TEST_3_11_2_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: YolkenTest3_11_2) => {
    ...
    test('default logLevel is warn', async () => {
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      process.env['YOLKEN_TEST_3_11_2_LOG'] = 'debug';
      const client = new YolkenTest3_11_2({ logger: logger, apiKey: 'My API Key' });
    ...
    test('warn when env var level is invalid', async () => {
      ...
      process.env['YOLKEN_TEST_3_11_2_LOG'] = 'not a log level';
      const client = new YolkenTest3_11_2({ logger: logger, apiKey: 'My API Key' });
      expect(client.logLevel).toBe('warn');
      expect(warnMock).toHaveBeenCalledWith(
        'process.env[\'YOLKEN_TEST_3_11_2_LOG\'] was set to "not a log level", expected one of ["off","error","warn","info","debug"]',
      );
    });
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['YOLKEN_TEST_3_11_2_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new YolkenTest3_11_2({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['YOLKEN_TEST_3_11_2_BASE_URL'] = 'https://example.com/from_env';
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['YOLKEN_TEST_3_11_2_BASE_URL'] = ''; // empty
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://petstore3.swagger.io/api/v3');
    });

    test('blank env variable', () => {
      process.env['YOLKEN_TEST_3_11_2_BASE_URL'] = '  '; // blank
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://petstore3.swagger.io/api/v3');
    });
    ...
    test('in request options overridden by client options', () => {
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['YOLKEN_TEST_3_11_2_BASE_URL'] = 'http://localhost:5000/env';
      const client = new YolkenTest3_11_2({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new YolkenTest3_11_2({ maxRetries: 4, apiKey: 'My API Key' });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new YolkenTest3_11_2({ apiKey: 'My API Key' });
...
describe('retries', () => {
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new YolkenTest3_11_2({ apiKey: 'My API Key', fetch: testFetch });
